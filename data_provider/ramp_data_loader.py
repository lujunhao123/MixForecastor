...
class Wind(Dataset):
    ...
    def __read_data__(self):
        ...
        df_raw = pd.read_csv(rf"dataset/{self.site}_labeled_dataset.csv")
        ...
        wind_farms_number = int(columns_number/2)
        df_data_lr = df_raw.iloc[:, 1:wind_farms_number + 1]
        df_data_dr = df_raw.iloc[:, wind_farms_number + 1:] + 1.0
    ...
    def __getitem__(self, index):
        ...
        return batch_x_dis, batch_x_con, batch_y_dis, batch_y_con, seq_x_mark, seq_y_mark
